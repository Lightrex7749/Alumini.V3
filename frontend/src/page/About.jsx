...
const About = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-gray-900">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-blue-600 to-blue-800 text-white py-20 px-4 relative overflow-hidden">
        ...
        <div className="absolute bottom-10 right-20 w-72 h-72 bg-purple-400/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => {
              ...
              return (
                ...
                <GlowBorderCard className="text-center p-6">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <StaggerItem key={index}>
                <TiltCard className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 h-full">
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-blue-600 to-blue-800 text-white relative overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <ShineButton className="px-8 py-3 text-lg bg-white text-blue-600 hover:bg-gray-100">
