...
import { BlurFade, Spotlight, GradientHeading, ShineButton } from '@/components/ui/aceternity';
...
const ResetPassword = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-72 h-72 bg-purple-300/30 rounded-full mix-blend-multiply filter blur-xl animate-pulse" />
      <div className="absolute bottom-20 right-10 w-72 h-72 bg-blue-300/30 rounded-full mix-blend-multiply filter blur-xl animate-pulse" style={{ animationDelay: '2s' }} />
      
      <BlurFade delay={0.1}>
      <Card className="w-full max-w-md relative backdrop-blur-sm bg-white/95 shadow-xl border border-white/20">
